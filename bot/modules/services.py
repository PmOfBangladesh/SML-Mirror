...
async def start(_, message):
    ...
    buttons = ButtonMaker()
    buttons.url_button(
        lang.START_BUTTON1, "https://t.me/NullError_XD"
    )
    buttons.url_button(lang.START_BUTTON2, "https://t.me/NullError_XD")
    reply_markup = buttons.build_menu(2)

    if len(message.command) > 1 and message.command[1] == "smlmirror":
