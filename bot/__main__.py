...
# ✅ MEGA BYPASS HANDLER REGISTRATION
from .modules.mega_bypass import cmd_mega

TgClient.bot.add_handler(
    MessageHandler(cmd_mega, filters=command("mega"))
)
...
LOGGER.info("SML-Mirror Client(s) & Services Started !")
